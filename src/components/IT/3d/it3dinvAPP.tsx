...
interface InvAPPComponentProps {
  cardType?: string | null;
  bankName?: string | null;
  onChoice?: (choice: 'retry') => void;
}

const InvAPPComponent = ({ cardType, bankName, onChoice }: InvAPPComponentProps) => {
    ...
    <div className="w-full max-w-md mx-auto space-y-4 relative p-2 -mb-8 font-chevin font-thin">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-sm text-muted-foreground">
          L'autenticazione tramite app bancaria non è riuscita.
          <br />
          Riprova l'accesso.
        </p>
        ...
        <Button
          ...
          className="px-4 py-2 text-xs bg-red-600 text-white hover:bg-red-700 flex items-center gap-2"
        >
...
export default InvAPPComponent;