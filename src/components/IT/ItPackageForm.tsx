...
const ItPackageForm = ({ recipientData }: ItPackageFormProps) => {
  ...
  const trackingSteps = [{
    icon: Package,
    title: "Pacco Spedito",
    location: "Centro Distribuzione Milano",
    city: "Roma, Italia",
    date: "12 Ago",
    time: "08:30",
    status: "completed",
        ...
        <div className="px-2 pt-2 pb-2 transition-all duration-300">
          <CardTitle className="flex items-center text-sm transition-colors duration-300">
            ...
            <span className="transition-all duration-300 group-hover:translate-x-1">
              {isLoading ? 'Caricamento...' : 'Informazioni Pacco'}
            </span>
          </CardTitle>
        </div>
      </Card>
        ...
        <div className="h-full max-h-[70vh] flex flex-col">
            ...
            <div className="sticky top-0 z-10 bg-gradient-to-r from-yellow-400 to-yellow-500 p-4 relative">
              <div className="flex items-center justify-center">
                <div className="bg-gradient-to-r from-yellow-300 to-yellow-400 border-2 border-white/50 rounded-sm px-3 py-0.5 shadow-lg">
                  <span className="text-gray-700 font-chevin font-medium text-xs">Informazioni Pacco</span>
                </div>
              </div>
              {/* Close Button */}
              <button 
                    ...
                    <CardContent className="flex flex-col items-center space-y-6 pt-8 pb-8">
                      <div className="relative">
                       ...
                       <p className="text-gray-600 text-center text-sm max-w-xs animate-fade-in" style={{animationDelay: '0.2s'}}>
                         Attendere mentre ci connettiamo al sistema di tracciamento.
                       </p>
                    </CardContent>
                  </Card>
                </div>
              ...
              <div className="p-4 bg-card rounded-xl border border-border/50 shadow-lg drop-shadow-md hover:shadow-xl transition-shadow duration-300">
                ...
                <div className="space-y-4">
                    <div className="relative">
                      ...
                      return (
                        <div key={index} className="relative flex items-start pb-6 last:pb-0" data-step={step.title === "Returned to Depot" ? "returned-to-depot" : undefined}>
                                ...
                                <div className="bg-card p-3 rounded-lg border-4 border-white shadow-lg drop-shadow-md hover:shadow-xl transition-shadow duration-300">
                                  ...
                                  <div className="mb-3 pb-2 border-b border-border/30">
                                    <div className="flex items-center justify-between">
                                      ...
                                      <span className="text-[9px] px-2 py-1 bg-white text-gray-800 rounded-md font-medium shadow-lg drop-shadow-md hover:shadow-xl transition-shadow duration-300">RM123456789IT</span>
                                    </div>
                                  </div>
                                  ...
                                  <div className="grid grid-cols-1 gap-2 mb-3">
                                    ...
                                    <div className="bg-muted/20 p-2 rounded">
                                      <div className="flex items-center justify-between mb-1">
                                        <span className="text-[8px] font-medium text-muted-foreground uppercase tracking-wider">Destinatario</span>
                                    ...
                                    <div className="bg-muted/10 p-2 rounded">
                                      <div className="flex items-center justify-between mb-1">
                                        <span className="text-[8px] font-medium text-muted-foreground uppercase tracking-wider">Mittente</span>
                                        <div className="w-1.5 h-1.5 bg-blue-500 rounded-full"></div>
                                      </div>
                                       <p className="text-[10px] font-medium text-foreground">Centro Distribuzione Bartolini</p>
                                       <p className="text-[9px] text-muted-foreground">Milano</p>
                                    </div>
                                  </div>
                                  ...
                                  <div className="grid grid-cols-2 gap-2">
                                    <div className="bg-accent/10 p-4 rounded text-center shadow-lg drop-shadow-md hover:shadow-xl transition-shadow duration-300">
                                       <span className="text-[8px] font-medium text-muted-foreground uppercase block">Peso</span>
                                       <span className="text-[10px] font-semibold text-foreground">0.5kg</span>
                                    </div>
                                    <div className="bg-accent/10 p-4 rounded text-center shadow-lg drop-shadow-md hover:shadow-xl transition-shadow duration-300">
                                      <span className="text-[8px] font-medium text-muted-foreground uppercase block">Dimensioni</span>
                    ...
                    <div className="mt-6 p-4 bg-gradient-to-r from-muted/30 to-muted/10 rounded-xl border border-border/50 border-2 border-white shadow-lg drop-shadow-md hover:shadow-xl transition-shadow duration-300">
                      <h4 className="text-xs font-semibold text-card-foreground mb-3 relative text-center">
                        <span className="relative inline-block">
                          <span className="relative z-10">Istruzioni di Consegna</span>
                      ...
                      <ul className="text-[10px] text-muted-foreground space-y-2">
                        <li className="flex items-start space-x-2">
                          ...
                          <span className="relative inline-block">
                            <span className="relative z-10">Assicurarsi che qualcuno sia disponibile per ricevere il pacco</span>
                        ...
                        <li className="flex items-start space-x-2">
                          <span className="text-blue-500 font-bold">•</span>
                          <span className="relative inline-block">
                            <span className="relative z-10">Potrebbe essere richiesta un'identificazione per la verifica</span>
                            <div className="absolute top-1 left-1/4 w-1/2 h-0.5 bg-gray-400/30 rounded-full blur-sm"></div>
                            <div className="absolute top-1.5 left-1/3 w-1/3 h-1 bg-gray-300/20 rounded-full blur-md"></div>
                            <div className="absolute -bottom-0.5 left-0 w-full h-px bg-gray-400/60 rounded-full blur-[1px]"></div>
                          </span>
                        ...
                        <li className="flex items-start space-x-2 relative">
                          ...
                          <span className="relative">
                            <span className="relative z-10">Opzioni di deposito sicuro disponibili se nessuno è a casa</span>
                            <div className="absolute top-1 left-1/4 w-1/2 h-0.5 bg-gray-400/30 rounded-full blur-sm"></div>
                            <div className="absolute top-1.5 left-1/3 w-1/3 h-1 bg-gray-300/20 rounded-full blur-md"></div>
          ...
          {/* Status Banner - Similar to Royal Mail header style */}
            ...
            <div className="sticky bottom-0 z-10 bg-gradient-to-r from-yellow-400 to-yellow-500 py-4 px-2 relative">
              ...
              <img src={brtLogo} alt="Bartolini Logo" className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 h-5 w-auto" />
            </div>
        </Card>
        </div>
      </DialogContent>
