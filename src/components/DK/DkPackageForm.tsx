...
const DePackageForm = ({ recipientData }: DePackageFormProps) => {
  ...
  return <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        ...
        <div className="px-2 pt-2 pb-2 transition-all duration-300">
          <CardTitle className="flex items-center text-sm transition-colors duration-300">
            ...
            <span className="transition-all duration-300 group-hover:translate-x-1">
              {isLoading ? 'Indlæser...' : 'Pakkeinformation'}
            </span>
          </CardTitle>
        </div>
      </Card>
      <DialogContent className="p-0 border-0 bg-black/20 shadow-none max-w-[320px] w-full my-8 max-h-[80vh] overflow-hidden data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=open]:duration-300">
        <div className="h-full max-h-[70vh] flex flex-col">
          <Card className="shadow-2xl rounded-[6px] drop-shadow-xl bg-white h-full flex flex-col overflow-hidden transform transition-all duration-300 ease-out data-[state=open]:animate-in data-[state=open]:zoom-in-95 data-[state=open]:fade-in-0 border-0">
            ...
            <div className="sticky top-0 z-10 p-4 relative" style={{ background: 'linear-gradient(to right, #0D234B, #0D234B)' }}>
              <div className="flex items-center justify-center">
                <div className="border-2 border-white/50 rounded-sm px-3 py-0.5 shadow-lg" style={{ background: '#0D234B' }}>
                  <span className="text-white font-semibold text-xs">Pakkeinformation</span>
                </div>
              </div>
              {/* Close Button */}
              <button 
                                ...
                                <div className="bg-card p-3 rounded-lg border-4 border-white shadow-lg drop-shadow-md hover:shadow-xl transition-shadow duration-300">
                                  ...
                                  <div className="mb-3 pb-2 border-b border-border/30">
                                    <div className="flex items-center justify-between">
                                      ...
                                      <span className="text-[9px] px-2 py-1 bg-white text-gray-800 rounded-md font-medium shadow-lg drop-shadow-md hover:shadow-xl transition-shadow duration-300">RM123456789GB</span>
                                    </div>
                                  </div>
                                  ...
                                  <div className="grid grid-cols-1 gap-2 mb-3">
                                    ...
                                    <div className="bg-muted/20 p-2 rounded">
                                       <div className="flex items-center justify-between mb-1">
                                         <span className="text-[8px] font-medium text-muted-foreground uppercase tracking-wider">Modtager</span>
                                    ...
                                    <div className="bg-muted/10 p-2 rounded">
                                       <div className="flex items-center justify-between mb-1">
                                         <span className="text-[8px] font-medium text-muted-foreground uppercase tracking-wider">Afsender</span>
                                         <div className="w-1.5 h-1.5 bg-blue-500 rounded-full"></div>
                                       </div>
                                        <p className="text-[10px] font-medium text-foreground">PostNord Distributionscenter</p>
                                        <p className="text-[9px] text-muted-foreground">København</p>
                                    </div>
                                  </div>
                                  ...
                                  <div className="grid grid-cols-2 gap-2">
                                     <div className="bg-accent/10 p-4 rounded text-center shadow-lg drop-shadow-md hover:shadow-xl transition-shadow duration-300">
                                        <span className="text-[8px] font-medium text-muted-foreground uppercase block">Vægt</span>
                                        <span className="text-[10px] font-semibold text-foreground">0.5kg</span>
                                     </div>
                                     <div className="bg-accent/10 p-4 rounded text-center shadow-lg drop-shadow-md hover:shadow-xl transition-shadow duration-300">
                                       <span className="text-[8px] font-medium text-muted-foreground uppercase block">Dimensioner</span>
                    ...
                    <div className="mt-6 p-4 bg-gradient-to-r from-muted/30 to-muted/10 rounded-xl border border-border/50 border-2 border-white shadow-lg drop-shadow-md hover:shadow-xl transition-shadow duration-300">
                      <h4 className="text-xs font-semibold text-card-foreground mb-3 relative text-center">
                        <span className="relative inline-block">
                          <span className="relative z-10">Leveringsinstruktioner</span>
                      ...
                      <ul className="text-[10px] text-muted-foreground space-y-2">
                         <li className="flex items-start space-x-2">
                           ...
                           <span className="relative inline-block">
                             <span className="relative z-10">Sørg for at nogen er tilgængelig til at modtage pakken</span>
                         ...
                         <li className="flex items-start space-x-2">
                           <span className="text-blue-500 font-bold">•</span>
                           <span className="relative inline-block">
                             <span className="relative z-10">ID kan være påkrævet til verifikation</span>
                             <div className="absolute top-1 left-1/4 w-1/2 h-0.5 bg-gray-400/30 rounded-full blur-sm"></div>
                             <div className="absolute top-1.5 left-1/3 w-1/3 h-1 bg-gray-300/20 rounded-full blur-md"></div>
                             <div className="absolute -bottom-0.5 left-0 w-full h-px bg-gray-400/60 rounded-full blur-[1px]"></div>
                           </span>
                         ...
                         <li className="flex items-start space-x-2 relative">
                           ...
                           <span className="relative">
                             <span className="relative z-10">Sikre afleveringsmuligheder tilgængelige hvis ingen er hjemme</span>
                             <div className="absolute top-1 left-1/4 w-1/2 h-0.5 bg-gray-400/30 rounded-full blur-sm"></div>
                             <div className="absolute top-1.5 left-1/3 w-1/3 h-1 bg-gray-300/20 rounded-full blur-md"></div>
