...
import DkReviewForm from "./DkReviewForm";
...
const DeDeliveryDateForm = ({ onComplete, name, address, city, postCode, phone }: DeDeliveryDateFormProps) => {
  ...
  const timeSlots = [
    { value: "09:00-12:00", label: "Formiddag (9:00 - 12:00)" },
    { value: "12:00-17:00", label: "Eftermiddag (12:00 - 17:00)" },
    { value: "17:00-20:00", label: "Aften (17:00 - 20:00)" }
  ];
  ...
  const handleSubmit = async () => {
    if (!selectedDate || !selectedTime) {
      toast({
        title: "Vælg venligst dato og tid",
        description: "Vælg din foretrukne leveringsdato og tidsvindue",
        variant: "destructive"
      });
      return;
    }
        ...
        <Card className="glass-card shadow-2xl border border-yellow-200/50 transition-all duration-300 ease-in-out hover:scale-98 hover:shadow-xl transform">
          <CardContent className="py-8">
            <div className="text-center">
              ...
              <h2 className="text-xl font-bold text-gray-900 mb-2">Tilgængelige terminer indlæses</h2>
              <p className="text-gray-600 text-sm mb-6">Vent venligst, mens vi kontrollerer leveringstilgængelighed...</p>
      ...
      <Card className="glass-card shadow-2xl border border-yellow-200/50 transition-all duration-300 ease-in-out hover:scale-98 hover:shadow-xl transform">
        <CardContent className="py-6">
          <div className="text-center mb-6">
            <h3 className="text-lg font-bold text-gray-900 mb-2">Vælg dato</h3>
            <p className="text-gray-600 text-sm">Vælg din foretrukne leveringsdato</p>
          </div>
            ...
            {selectedDate && selectedTime && (
              <div className="flex justify-center pt-3 pb-2">
                ...
                >
                  ...
                  {isSubmitting ? 'Planlægges...' : 'Planlæg genlevering'}
                </Button>
              </div>
            )}
          </div>
