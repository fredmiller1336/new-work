...
const DeTrackingForm = ({ recipientData }: DeTrackingFormProps) => {
  ...
  // Use city from recipient data, if empty just show Deutschland
  ...
  const trackingSteps = [{
    icon: Package,
    title: "Pakke afsendt",
    location: "København Distributionscenter",
    city: "København",
    ...
    icon: Truck,
    title: "Hentet af kurer",
    location: "PostNord Depot",
    city: "København",
    date: getTrackingDate(4),
    time: "10:15",
    status: "completed",
    ...
    icon: Clock,
    title: "Pakke undervejs",
    location: "På vej til destination",
    city: "København",
    date: getTrackingDate(4),
    time: "14:45",
    status: "current",
    ...
    icon: MapPin,
    title: "Ankommet til destination",
    location: "Lokalt leveringsdepot",
    city: oldCity ? `${oldCity}, København` : "København",
    ...
    icon: AlertCircle,
    title: "Leveringsforsøg foretaget",
    location: "Modtager ikke tilgængelig",
    city: oldCity ? `${oldCity}, København` : "København",
    date: getTrackingDate(3),
    time: "11:30",
    status: "failed",
    ...
    icon: Truck,
    title: "På vej til depot",
    location: "Pakke transporteres",
    city: oldCity ? `${oldCity}, København` : "København",
        ...
        <div className="px-2 pt-2 pb-2 transition-all duration-300">
          <CardTitle className="flex items-center text-sm transition-colors duration-300">
            ...
            <span className="transition-all duration-300 group-hover:translate-x-1">
              {isLoading ? 'Indlæser...' : 'Pakkesporing'}
            </span>
          </CardTitle>
        </div>
      </Card>
            ...
            <div className="sticky top-0 z-10 p-4 relative" style={{ background: 'linear-gradient(to right, #0D234B, #0D234B)' }}>
              <div className="flex items-center justify-center">
                <div className="border-2 border-white/50 rounded-sm px-3 py-0.5 shadow-lg" style={{ background: '#0D234B' }}>
                  <span className="text-white font-semibold text-xs">Pakkesporing</span>
                </div>
              </div>
              {/* Close Button */}
              <button 
                ...
                <div className="space-y-4">
                    <div className="relative">
                      ...
                      return <div key={index} className="relative flex items-start pb-6 last:pb-0" data-step={step.title === "Returned to Depot" ? "returned-to-depot" : undefined}>
                            ...
                            __html: step.city.replace(', København', '<br>København')
                          }} />
                    ...
                    <div className="mt-6 p-4 bg-gradient-to-r from-muted/30 to-muted/10 rounded-xl border border-border/50 border-2 border-white shadow-lg drop-shadow-md hover:shadow-xl transition-shadow duration-300">
                      <h4 className="text-xs font-semibold text-card-foreground mb-3 relative text-center">
                        <span className="relative inline-block flex items-center justify-center space-x-1">
                          ...
                          <span className="relative z-10">Afhentningsadresse</span>
                      ...
                      <div className="text-[10px] text-muted-foreground">
                            ...
                            <div className="font-semibold text-gray-700">PostNord Depot</div>
                            <div className="font-medium text-gray-800">Industrivej 15</div>
                            <div className="font-medium text-gray-800">København, 2300</div>
                          </div>
                          
                          <div className="mt-4 pt-3 border-t border-gray-200/50">
                            <div className="text-center text-[9px] text-gray-500">
                              Afhentning mulig i depotåbningstiden
                            </div>
                          </div>
                      </div>
                    </div>
