...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-50 bg-gradient-to-r from-primary to-primary-light text-primary-foreground shadow-lg relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <nav className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-1">
            <Button 
              variant="ghost" 
              className="text-white hover:bg-white/20 hover:text-white transition-all duration-300 group"
            >
        ...
        {/* Mobile Navigation */}
        {isMenuOpen && (
          <div className="md:hidden mt-4 py-4 border-t border-white/20 animate-fade-in">
