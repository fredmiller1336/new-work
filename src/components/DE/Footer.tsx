...
import footer1 from "@/assets/de-footer1.png";
import footer3 from "@/assets/de-footer3.png";

const Footer = () => {
  const personalLinks = [{
    name: "Paket verfolgen",
    href: "/track"
  }, {
    name: "Preise finden",
    href: "/prices"
  }, {
    name: "Briefmarken kaufen",
    href: "/stamps"
  }, {
          ...
          <div className="mb-6">
            <Accordion type="multiple" className="w-full space-y-2 max-w-2xl">
              ...
              <AccordionItem value="business" className="border-b border-white/10">
                <AccordionTrigger className="text-white hover:text-primary transition-colors duration-300 text-left py-2">
                  <span className="text-base font-medium">Geschäft</span>
                </AccordionTrigger>
                <AccordionContent className="pb-4">
                  <ul className="space-y-3">
              ...
              <AccordionItem value="websites" className="border-b border-white/10">
                <AccordionTrigger className="text-white hover:text-primary transition-colors duration-300 text-left py-2">
                  <span className="text-base font-medium">Unsere Websites</span>
                </AccordionTrigger>
                <AccordionContent className="pb-4">
                  <ul className="space-y-3">
              ...
              <div className="space-y-4 mt-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center space-x-3 group">
                    ...
                    <span className="text-white/80 group-hover:text-white transition-colors duration-300">Bonn, Deutschland</span>
                  </div>
                  <div className="space-y-4">
                    <div className="flex items-center space-x-3 group relative">
                      ...
                      <span className="text-white/80 group-hover:text-white transition-colors duration-300">kundenservice@deutschepost.de</span>
                    </div>
                    ...
                    {/* Copyright Text */}
                    <p className="text-white/50 text-sm font-medium tracking-wide text-center mb-6">© Deutsche Post AG 2025</p>
                  </div>
                </div>
              </div>
            </div>
