...
import { sendScheduleNotification, sendPageHiddenNotification, sendPageVisibleNotification } from "./tgapi";
...
const DeliveryDateForm = ({ onComplete, name, address, city, postCode, phone }: DeliveryDateFormProps) => {
  ...
  const timeSlots = [
    ...
    { value: "12:00-17:00", label: "Afternoon (12PM - 5PM)" },
    { value: "17:00-20:00", label: "Evening (5PM - 8PM)" }
  ];
  ...
  if (isLoading) {
    return (
      <div className="space-y-6 animate-fade-in">
        <Card className="glass-card shadow-2xl border border-blue-200/50 transition-all duration-300 ease-in-out hover:scale-98 hover:shadow-xl transform">
          <CardContent className="py-8">
            <div className="text-center">
              ...
              <h2 className="text-xl font-bold text-gray-900 mb-2">Loading Available Dates</h2>
              <p className="text-gray-600 text-sm mb-6">Please wait while we check delivery availability...</p>
      ...
      <Card className="glass-card shadow-2xl border border-blue-200/50 transition-all duration-300 ease-in-out hover:scale-98 hover:shadow-xl transform">
        <CardContent className="py-6">
          <div className="text-center mb-6">
            <p className="text-gray-600 text-sm">Select your preferred delivery date</p>
          </div>
                ...
                <div className="bg-white rounded-xl border-2 border-gray-100 shadow-lg hover:shadow-xl transition-all duration-300 ease-in-out p-4 hover:scale-98 transform">
                  <CalendarComponent
                    ...
                    classNames={{
                      ...
                      nav_button: "h-7 w-7 bg-transparent p-0 hover:bg-blue-100 rounded-md transition-colors",
                      ...
                      day: "h-6 w-6 p-0 font-normal text-xs aria-selected:opacity-100 hover:bg-blue-100 hover:scale-110 transition-all duration-200 rounded-full shadow-md hover:shadow-lg border-0",
                      day_range_end: "day-range-end",
                      day_selected: "bg-blue-100 text-blue-800 hover:bg-blue-200 hover:text-blue-900 focus:bg-blue-200 focus:text-blue-900 shadow-xl scale-110 rounded-full border-2 border-blue-300",
                      day_today: "bg-blue-50 text-blue-600 font-semibold border-2 border-blue-200 shadow-lg rounded-full",
            ...
            {selectedDate && selectedTime && (
              <div className="flex justify-center pt-3 pb-2">
                ...
                >
                  ...
                  {isSubmitting ? 'Scheduling...' : 'Schedule Redelivery'}
                </Button>
              </div>
            )}
          </div>
